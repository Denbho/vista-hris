...
class ResCountry(models.Model):
    ...
    continent_id = fields.Many2one('res.continent', string="Continent")
    continent_region_id = fields.Many2one('res.continent.region', string="Continent Region",
                                          domain="[('continent_id', '=', continent_id)]")
...
class ResIslandGroup(models.Model):
    ...
    continent_region_id = fields.Many2one('res.continent.region', string="Continent Region",
                                          domain="[('continent_id', '=', continent_id)]")
    country_id = fields.Many2one('res.country', string="Country",
                                 domain="[('continent_region_id', '=', continent_region_id)]")
...
class ResBarangay(models.Model):
    _name = 'res.barangay'
    _description = "Country Barangays"
